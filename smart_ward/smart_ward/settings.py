"""
Django settings for smart_ward project.
...
SECRET_KEY = 'django-insecure-6#-!wh4mdbty4#641_r74m9#-z2+uuy)#@uw+e(l^$4u@(@0)g'
...
ASGI_APPLICATION = 'smart_ward.asgi.application'
...
WSGI_APPLICATION = 'smart_ward.wsgi.application'
